...
const zergling_1 = require("../src/units/zergling");
const marine_1 = require("../src/units/marine");
const zealot_1 = require("../src/units/zealot");
describe('can do battle', () => {
    it('the vile zerg zergling will kill the epic terran marine', () => {
        const marine = new marine_1.Marine();
        const zergling = new zergling_1.Zergling();
        const zerglingTwo = new zergling_1.Zergling();
        zergling.run(marine);
    ...
    it('the vile zerg zerglings will kill the epic protos zealot', () => {
        const zealot = new zealot_1.Zealot();
        const zergling = new zergling_1.Zergling();
        const zerglingTwo = new zergling_1.Zergling();
        zergling.run(zealot);
